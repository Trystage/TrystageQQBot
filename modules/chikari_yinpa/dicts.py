...
class dicts():
    ...
    yinpa_help_dict = {
        ...
        "yinpa_control":"yinpa_control\n命令：yinpa_control <enabledisable>\n命令别称：银趴控制\n控制本群银趴的开启关闭",
        "info":"info\n命令：info [@某人]\n命令别称：信息 查询\n查询自己或某人的银趴信息",
        "tou":"tou\n命令：tou <@某人 或 银趴昵称>\n命令别称：透 插入\n透某人",
        "zha":"zha\n命令：zha <@某人 或 银趴昵称>\n命令别称：榨 榨精\n榨某人",
        "chong":"chong\n命令：chong\n命令别称：冲 打胶 手冲 撸 导\n冲一发，能够增加或减少一定长度",
    ...
    shop_help = {
        "伟哥":"伟哥（ID：1）\n标签上写着：“味道好极了”\n购买后获得升级状态：伟哥（ID：3）（一小时内造成的伤害增加1d30）",
        ...
        "自然蕴息宝珠":"自然蕴息宝珠（ID：10）\n发光的绿色珠子\n看着就让人感到安心\n购买后获得升级技能：自然蕴息宝珠（ID：8）",
        "屹立不倒":"屹立不倒（ID：11）\n屹（弟）立（弟）不倒！\n使你在失神状态下也能行动\n购买后获得升级技能：屹立不倒（ID：9）",
        "潘多拉魔盒":"潘多拉魔盒（ID：12）\n收纳诅咒之物\n如果适当地使用，也许并不会带来负面效果\n购买后失去所有【诅咒】技能",
        "开启的潘多拉魔盒":"开启的潘多拉魔盒（ID：13）\n诅咒之力倾泻而出\n带来力量，抑或灾祸\n购买后获得5个随机诅咒技能\n随机一个技能根据「所有技能总等级的对数缩放值」乘以「原等级的平方根」来提升（原等级至少为1）\n最后清除0级技能。",
        "D10":"D10（ID：14）\n转动的骰子\n购买后进行1d10：\n1：长度（*0.1）\n2：深度（*0.1）\n3：力量\n4：体质\n5：技巧\n6：意志\n7：智力\n8：魅力\n9：金钱（*1000）\n10：大成功大失败\n使骰中的属性增加1d10\n大成功大失败则变为增加减少1d100",
        "粉色小药丸":"粉色小药丸（ID：15）\n喵喵制造的神秘邀请函?~\n购买后失神10分钟",
        "喵喵玩具":"喵喵玩具（ID：16）\n喵喵制造的神秘小玩具~\n购买后一小时内紫薇增加更多长度/深度。",
        "圣女服":"圣女服（ID：17）\n奇怪的圣女服，穿上去会成为圣教的圣女。咦？为什么有点凉嗖嗖的。\n购买后获得升级技能：庇护（ID：16）"
    }
    """商店帮助
    """
